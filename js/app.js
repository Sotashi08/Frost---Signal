/* app.js — расширенная версия
   Сохранена логика: змейки, партиклы, звуки, проверка слова, зелёный/красный flash.
   Добавлено: категории слов, подсказки с прогресс-баром, ограничения на абуз.
*/
...
const CATEGORIES = {
    "Арктика": [
        "мороз","лед","айсберг","метель","снегопад","сугроб","иней","пурга","тундра","полюс",
        "палатка","берег","ледник","север","полярник","о́лень","тюлень","мираж","морж","бухта",
        "океан","шельф","пингвин","па́ти́на","капля"
    ],
    "Технологии": [
        "алгоритм","протокол","шифр","сервер","клиент","хостинг","облако","контейнер","криптография",
        "парсер","фреймворк","рендер","интерфейс","компиляция","кэширование","нейросеть","датасет",
        "биткоин","модуль","процессор","пакет","плейбек","логика","бит","поток"
    ],
    "Литература": [
        "сонет","рифма","метафора","аллегория","баллада","эпос","проза","лиризм","гипербола",
        "анафора","куплет","строфа","персонаж","драма","афоризм","парадокс","символ","роман",
        "повествование","образ","фраза","жанр","сатира","поэма","балет"
    ]
};
...
/* -------------------------
   Новые DOM элементы подсказок (создадим динамически)
   -------------------------*/
